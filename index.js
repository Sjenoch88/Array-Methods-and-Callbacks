...
//console.log('task 1E', finals2014[0]('Winner of 2014 world cup final'));
...
function getYears(array, cbfunction) {
    const years = cbfunction(array).year;
    return years;
...
function getWinnersByYear(array, getfinalcb) {
    const winners = getfinalcb(array).map(function(item)
